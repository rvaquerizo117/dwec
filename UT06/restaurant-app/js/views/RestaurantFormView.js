    ...
    renderRestaurantsTable(restaurants) {
        ...
        for (const restaurant of restaurants) {
            ...
            deleteButton.onclick = () => {
                this.controller.removeRestaurant(restaurant.name);
    ...
    validateAndSaveRestaurant() {
        ...
        if (isValid) {
            try {
                ...
                this.restaurantView.updateRestaurantMenu(this.controller.restaurantsManager.restaurantsIterator); // Update menu after adding
