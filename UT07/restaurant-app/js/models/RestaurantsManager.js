// js/models/RestaurantsManager.js
...
class RestaurantsManager {
    ...
    logChange(action, objectType, object) {
    ...
    addCategory(category) {
        ...
        this.logChange('create', 'category', category);
        return this;
    }
    ...
    removeCategory(category) {
        ...
        this.logChange('delete', 'category', category);
    ...
    addDish(dish) {
        ...
        this.dishes.set(normalizedDishName, dish);
        this.logChange('create', 'dish', dish); 
    }
    ...
    removeDish(dish) {
        ...
        this.logChange('delete', 'dish', dish);
...
removeDishFromMenu(dish, menu) {
    ...
    addRestaurant(restaurant) {
        ...
        this.logChange('create', 'restaurant', restaurant); // Registrar creación
        return this;
    }
    ...
    removeRestaurant(restaurant) {
        ...
        this.logChange('delete', 'restaurant', restaurant); // Registrar eliminación
        return this;
    }
